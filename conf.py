...
BLOG_TITLE = "Antoine Falaize"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://afalaize.github.io/"
...
# Name of the theme to use in ["maupassant", "bootstrap3", "zen"]
THEME = "maupassant"

# NAVIGATION_LINKS for bootstrap3 and maupassant
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
...
# NAVIGATION_LINKS for zen
# NAVIGATION_LINKS = {
#         DEFAULT_LANG: (
#             ('/index.html', 'Home', 'icon-home'),
#             ('/pages/publications', 'Publications', 'icon-file-text'),
